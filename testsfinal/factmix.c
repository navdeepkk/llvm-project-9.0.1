...
int main() {
	...
	foo : {
		...
		fact : {
			...
			fact();									//this call should return without doing anyhting as b has already been reduced to 1 and should print 120.
			printf("factorial is :%d \n", res);
			b = 6;
			res = 1;  
			fact();									//this call should return the factorial of 6 as b and res have been restored once again.
			printf("factorial is :%d \n", res);
		}
	}
